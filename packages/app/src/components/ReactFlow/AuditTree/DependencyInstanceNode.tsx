...
import { AuditInstance } from "../../../service/api/types";

export default function DependencyInstanceNode(
  props: NodeProps<
    Node<AuditInstance & { isBeingDragged: boolean } & Record<string, unknown>>
  >,
) {
