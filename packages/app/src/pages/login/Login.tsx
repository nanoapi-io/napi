          ...
          <Card className="w-full max-w-md m-auto bg-[#5848E80D] border-[#2D2B42] text-white">
            <div className="space-y-2 text-center">
              ...
              <p className="text-gray-400">
                Choose a provider to continue with your development workflow
              </p>
            </div>
            <div className="space-y-4">
              <div className="flex flex-col justify-center gap-y-4 font-bold text-lg mt-5">
                <button
                  onClick={() => redirectToGitHubOAuth()}
                  className="flex justify-center bg-hover-light dark:bg-[#5848E80D] gap-x-1.5 p-3 rounded-md border-[1px] text-gray-700 dark:text-white border-gray-300 dark:border-search-bgDark hover:bg-[#5848E80D] dark:hover:bg-hover-dark transition-all grow"
                >
                  <svg
                    width="25"
                    height="24"
